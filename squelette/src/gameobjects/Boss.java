 ...
 *
 */
public class Boss extends Personnage implements Monstre{
     ...
     * @param imagePath
     */
    public Boss(double vie, List<Arme> armes, Vector2 position, Vector2 size, double speed, String imagePath,boolean invincible) {
